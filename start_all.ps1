...
Write-Host "[2/3] Starting CV Engine API (Port 8002)..." -ForegroundColor Yellow
Start-Process cmd -ArgumentList "/k cd /d `"$rootDir\cv_engine`" && python -m uvicorn app:app --port 8002 --reload"
...
Write-Host "  - CV Engine Docs:    http://127.0.0.1:8002/docs" -ForegroundColor Green
Write-Host "========================================================" -ForegroundColor Green
